/**
 * LoginSchoolView - Page de connexion pour le personnel d'école
 *
 * Redirige vers le dashboard école après connexion.
 */
...
export default function LoginSchoolView() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        if (schoolOrg) {
          // Priorité à l'espace école (puisqu'on vient du portail école)
          ...
          // Sinon, espace entreprise si disponible
      ...
      console.error("Erreur connexion école:", err);
    ...
    <div className="min-h-screen bg-theme-bg-primary flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-theme-card border border-theme-card-border rounded-2xl p-8 shadow-theme-xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-theme-text-secondary mt-2">
              Connectez-vous à votre espace d'administration école
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@efrei.fr"
                  className="w-full pl-12 pr-4 py-3 bg-theme-bg-secondary border border-theme-border rounded-xl text-theme-text-primary placeholder-theme-text-muted focus:border-blue-500 focus:outline-none"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-12 pr-12 py-3 bg-theme-bg-secondary border border-theme-border rounded-xl text-theme-text-primary placeholder-theme-text-muted focus:border-blue-500 focus:outline-none"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold rounded-xl hover:from-blue-600 hover:to-indigo-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
        ...
        <p className="mt-6 text-center text-sm text-theme-text-muted">
          Cette page est réservée au personnel des écoles partenaires.
          <br />
          (Admin, Coach, Professeur)
        </p>
      </div>
    </div>
  );
