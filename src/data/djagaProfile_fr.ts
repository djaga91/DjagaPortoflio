...
- Développement d'un script Python qui liste la centaine de tokens d'accès GitLab de l'équipe, identifie leur provenance et génère un tableau Excel exploitable pour les audits de sécurité et la conformité.
...
→ Couverture multi-langages (Python, Java) sur 3 niveaux de gravité (clean, normal, agressif) pour mesurer la capacité réelle de chaque outil à détecter les failles attendues.
